    ...
    <b-container>
      <section style="text-align: center; margin-top: 200px; margin-bottom: 100px;">
        ...
        <h4 class="pb-5 border-bottom">
          <strong style="font-weight: 900">개인정보 처리방침</strong>
        </h4>
      </section>
    </b-container>
    <b-container>
      <b-row>
        <b-col>
          <p>
            (주) 크루드시스템('www.ssookssook.io'이하 '쑥메세지')은(는) 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.<br/>
            ○ 이 개인정보처리방침은 2021년 8월 27부터 적용됩니다.<br/>
            <br/>
            제1조(개인정보의 처리 목적)<br/>
            (주) 크루드시스템('www.ssookssook.io'이하 '쑥메세지')은(는) 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며 이용 목적이 변경되는 경우에는 「개인정보 보호법」 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.<br/>
            <br/>
            1. 홈페이지 회원가입 및 관리<br/>
            ...
            ① [ (주) 크루드시스템 ]은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집 시에 동의받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다.<br/>
            <br/>
            ...
            제3조(개인정보의 제3자 제공)<br/>
            <br/>
            ① [ (주) 크루드시스템 ]은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.<br/>
            <br/>
            ② [ (주) 크루드시스템 ]은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.<br/>
            <br/>
            1. [ 주식회사 카카오 ]<br/>
            개인정보를 제공받는 자 : 주식회사 카카오<br/>
            제공받는 자의 개인정보 이용목적 : 휴대전화번호, 회사전화번호<br/>
            제공받는 자의 보유.이용기간: 지체없이 파기<br/>
            <br/>
            2. [ 세종텔레콤(주) ]<br/>
            개인정보를 제공받는 자 : 세종텔레콤(주)<br/>
            제공받는 자의 개인정보 이용목적 : 휴대전화번호, 회사전화번호<br/>
            제공받는 자의 보유.이용기간: 지체없이 파기<br/>
            <br/>

            제4조(정보주체와 법정대리인의 권리·의무 및 그 행사방법)<br/>
            ① 정보주체는 (주) 크루드시스템에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.<br/>
            <br/>
            ② 제1항에 따른 권리 행사는(주) 크루드시스템에 대해 「개인정보 보호법」 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 (주) 크루드시스템은(는) 이에 대해 지체 없이 조치하겠습니다.<br/>
            <br/>
            ...
            <br/>
            ⑥ (주) 크루드시스템은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.<br/>
            <br/>
            제5조(처리하는 개인정보의 항목 작성)<br/>
            <br/>
            ① [ (주) 크루드시스템 ]은(는) 다음의 개인정보 항목을 처리하고 있습니다.<br/>
            <br/>
            1[ 홈페이지 회원가입 및 관리 ]<br/>
            필수항목 : 이메일, 휴대전화번호, 비밀번호 질문과 답, 비밀번호, 로그인ID, 이름, 회사전화번호, 직책, 부서, 회사명, 신용카드정보, 은행계좌정보, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보, 결제기록<br/>
            선택항목 : 자택주소, 자택전화번호, 성별, 생년월일, 직업, 기념일, 결혼여부, 취미, 신체정보, 학력, 종교<br/>

            제6조(개인정보의 파기)<br/>
            <br/>
            ① [ (주) 크루드시스템 ] 은(는) 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.<br/>
            <br/>
            ...
            1. 파기절차<br/>
            [ (주) 크루드시스템 ] 은(는) 파기 사유가 발생한 개인정보를 선정하고, [ (주) 크루드시스템 ] 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.<br/>
            <br/>
            2. 파기방법<br/>
            ...
            <br/>
            [ (주) 크루드시스템 ]은(는) 개인정보의 안전성 확보를 위해 다음과 같은 조치를 취하고 있습니다.<br/>
            <br/>
            1. 정기적인 자체 감사 실시<br/>
            ...
            [(주) 크루드시스템]('쑥메세지')은 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안프로그램을 설치하고 주기적인 갱신·점검을 하며 외부로부터 접근이 통제된 구역에 시스템을 설치하고 기술적/물리적으로 감시 및 차단하고 있습니다.<br/>
            <br/>
            5. 개인정보의 암호화<br/>
            ...
            ① (주) 크루드시스템 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다.<br/>
            ...
            제9조 (개인정보 보호책임자)<br/>
            <br/>
            ① (주) 크루드시스템 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.<br/>
            <br/>
            ▶ 개인정보 보호책임자<br/>
            성명 :강민구<br/>
            직책 :대표<br/>
            직급 :이사<br/>
            연락처 :023367800, manggo@crudsystem.co.kr, 023367822<br/>
            ...
            담당자 :강민구<br/>
            연락처 :023367800, manggo@crudsystem.co.kr, 023367822<br/>
            ② 정보주체께서는 (주) 크루드시스템 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. (주) 크루드시스템 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.<br/>
            <br/>
            제10조(개인정보 열람청구)<br/>
            정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다.<br/>
            [ (주) 크루드시스템 ]은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.<br/>
            <br/>
            ▶ 개인정보 열람청구 접수·처리 부서<br/>
            부서명 : 시스템 운영팀<br/>
            담당자 : 강민구<br/>
            연락처 : 023367822, manggo@crudsystem.co.kr, 023367822<br/>
            <br/>
            제11조(권익침해 구제방법)<br/>
